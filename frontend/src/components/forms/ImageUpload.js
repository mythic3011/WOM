 ...
 * @returns {string} HTML string for image upload component
 */
...
/**
 * Initialize image upload functionality with jQuery
...
/**
 * Get the selected image file using jQuery
 * @param {string} inputId - ID of the file input element
...
/**
 * Get the selected image as a data URL using jQuery
 * @param {string} inputId - ID of the file input element
...
/**
 * Clear the image upload input and preview using jQuery
 * @param {string} inputId - ID of the file input element
 * @param {string} previewId - ID of the preview container element
 * @param {string} defaultPreview - Optional default preview HTML
 */

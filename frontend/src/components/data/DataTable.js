...
export class DataTable {
    ...
    attachEventListeners() {
        ...
        // Use event delegation with jQuery
        $(document).on("change.datatable", `${tableSelector} .column-filter`, (e) => {
        ...
        $(document).on("click.datatable", `${tableSelector} #clearColumnFilters`, () => {
        ...
        $(document).on("click.datatable", `${tableSelector} #toggleColumnVisibility`, (e) => {
            e.stopPropagation();
            $(`${tableSelector} #columnVisibilityMenu`).toggleClass("hidden");
        });

        $(document).on("click.datatable", (e) => {
            const $target = $(e.target);
            if (!$target.closest(`${tableSelector} #toggleColumnVisibility, ${tableSelector} #columnVisibilityMenu`).length) {
                $(`${tableSelector} #columnVisibilityMenu`).addClass("hidden");
            }
        });

        $(document).on("change.datatable", `${tableSelector} .column-visibility-toggle`, (e) => {
            const $target = $(e.target);
            const column = $target.data("column");
    ...
    clearSelection() {
        ...
        $(`#${this.containerId} .table-row-select`).prop("checked", false);
    }
    ...
    destroy() {
        ...
        // Clean up event listeners with namespace
        $(document).off(".datatable");
    }
}
